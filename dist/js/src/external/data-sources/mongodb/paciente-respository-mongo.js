...
class PacienteRepositoryImpl {
    save(paciente) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const savedpaciente = yield ((_a = db_connect_1.collections.paciente) === null || _a === void 0 ? void 0 : _a.insertOne(paciente));
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            {
                const pacientes = yield ((_a = db_connect_1.collections.paciente) === null || _a === void 0 ? void 0 : _a.find());
                return pacientes;
            }
        });
    }
